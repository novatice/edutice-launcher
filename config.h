...
public:
    ...
    bool userIsTeacher() const { return m_userIsTeacher; }
    bool lockScreenEnable() const { return m_lockScreenEnable; }
    bool missingDefaultBrowser() const { return m_missingDefaultBrowser; }
    AppModel *applications() { return m_applications; }
    DirectoryModel *links() { return m_links; }
    AppModel *recommendedApps() { return m_recommendedApps; }
...
class Config : public QObject {
    ...
    Q_PROPERTY(bool printingsQueue READ printingsQueue CONSTANT)
...
public:
    Config(const QString &agentVersion, const bool assistance,
           const bool printings, const QString &OSVersion,
           const QString &serverAddress, const QString &token,
           Workspace *workspace);
    QString agentVersion() const { return m_agentVersion; }
    bool assistance() const { return m_assistance; }
    bool printingsQueue() const { return m_printingsQueue; }
